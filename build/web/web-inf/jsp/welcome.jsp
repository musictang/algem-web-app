  ...
  <body>
    <div class="centered">
      ...
      <table class="vertical-header">
        <tr><th><spring:message code="name.label" /></th><td><c:out value="${user.name}" /></td></tr>
        <tr><th><spring:message code="login.label" /></th><td>${user.login}</td></tr>
        <tr><th><spring:message code="profile.label" /></th><td><spring:message code="${user.profile.label}" text="${user.profile}" /></td></tr>
      </table>
    </div>
    <table>	
